...
class Rover {
    ...
    drawRotatedImage(grid) {
        ...
        grid.ctx.drawImage(this.alive, -grid.cnv.width / grid.size / 2, -grid.cnv.height / grid.size / 2, grid.cnv.width / grid.size, grid.cnv.height / grid.size);
...
onkeydown = onkeyup = function(e) {
    ...
    if (keyMap[13] === true && theEnd) { // key = enter
